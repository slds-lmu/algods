...
pa = pa + xlim(c(-2, 2)) + ylim(c(-2, 2)) + ggtitle(TeX('(1): Multiplikation mit $A$')) 
pa
...
pv = pv + xlim(c(-2, 2)) + ylim(c(-2, 2))  + ggtitle(TeX('(1): Multiplikation mit $V^T$'))
pv
...
pd = pd + xlim(c(-2, 2)) + ylim(c(-2, 2)) + ggtitle(TeX('(2): Multiplikation mit $\\Sigma$'))
pd
...
pu = pu + xlim(c(-2, 2)) + ylim(c(-2, 2)) + ggtitle(TeX('(3): Multiplikation mit $U$'))
pu
