...
\lecturechapter{\Sexpr{lecture_nr}}{Properties \& Examples of Big O}
...
$$
total time = time(statement_1) + time(statement_2) + \ldots + time(statement_k)
$$
...
\vfill
\begin{footnotesize}
More about the complexity of mathematical operations: \href{https://en.wikipedia.org/wiki/Computational_complexity_of_mathematical_operations}{\color{blue}\underline{Computational complexity of mathematical operations}}
\end{footnotesize}
...
print(xtable(summary(fib_table), digits = 0), booktabs=TRUE, caption.placement="top", size="\\fontsize{8pt}{9pt}\\selectfont")
@
...
By simply \enquote{counting} the nodes of this recursion tree you can determine the exact number of operations. \\
...
\framebreak
<<size = "scriptsize", tidy = FALSE, cache = TRUE>>=
fib2_table = microbenchmark(fib2(10), fib2(20), fib2(40), fib2(80), fib2(160),
                            times = 5000L)
@
<<size = "scriptsize", echo=FALSE, results='asis'>>=
print(xtable(summary(fib2_table), digits = 0), booktabs=TRUE, caption.placement="top", size="\\fontsize{8pt}{9pt}\\selectfont")
@
...
\textbf{Variations of Fibonacci(n): In C}

<<fib3, size = "scriptsize", warning=FALSE, message=FALSE>>=
library(inline)
...
@
<<size = "scriptsize", echo=FALSE, results='asis'>>=
print(xtable(summary(fib3_table), digits = 0), booktabs=TRUE, caption.placement="top", size="\\fontsize{8pt}{9pt}\\selectfont")
@
...
\textbf{Variations of Fibonacci(n): C++-version}
<<fib4, warning = FALSE, message=FALSE>>=
library(Rcpp)
...
<<fib5, size = "footnotesize">>=
suppressAll(library(expm))
fib5 = function(n) {
